...
return [
	...
	'cards' => [
		'sprite' => [
			...
			'content' => [
				'Voulez-vous voir votre propre sprite personnalisé prendre la place de Link? Commander <a href="https://github.com/fatmanspanda/ALttPNG/wiki" target="_blank" rel="noopener noreferrer">la documentation de fatmanspanda!</a>',
				'Pour plus d’informations sur la création de sprites et l’obtention d’un sprite personnalisé dans ALttP:R, connectez-vous avec #sprite-dev sur <a href="https://discord.gg/alttprandomizer" target="_blank" rel="noopener noreferrer">Discord</a>!',
			]
		],
		'live' => [
