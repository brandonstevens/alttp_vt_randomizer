	...
	'cards' => [
		'races' => [
			...
			'sections' => [
				...
				[
					'header' => 'Course hebdomadaire en mode standard, le samedi à 15h, heure de l’est des États-Unis',
					'content' => [
						'Le premier événement communautaire, la course hebdomadaire a beaucoup de concurrents!',
					],
				],
				[
					'header' => 'Course hebdomadaire en mode ouvert, le dimanche à 17h, heure de l’est des États-Unis',
					'content' => [
						'Rejoignez-nous le dimanche pour une autre course communautaire hebdomadaire populaire.',
					],
				],
				[
					'header' => 'La course nocturne communautaire, 22h heure de l’est des États-Unis ',
					'content' => [
