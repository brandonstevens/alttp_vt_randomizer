...
return [
	...
	'subheader' => 'Le Randomizer d’entrée vous permet de tourner le monde à l’envers et de jouer. Il devrait principalement suivre les règles VT standard pour les paramètres sur tout, mais il introduit une nouvelle option “' . __('entrance.shuffle.title') . '”.',
	'cards' => [
		'simple' => [
		...
		'restricted' => [
			...
			'content' => [
				'Utilise le brassage de donjon à partir de Simple mais connecte librement les entrées restantes. Les grottes et les donjons avec des entrées multiples seront confinés à un seul monde.',
			],
		],
		'full' => [
		...
		'insanity' => [
			...
			'content' => [
				'Découple les entrées et les sorties les unes des autres et les mélange librement. Les grottes qui étaient une seule entrée dans la vanille ne peuvent toujours sortir qu’au même endroit d’où elles sont entrées.',
			],
		],
	],
];
