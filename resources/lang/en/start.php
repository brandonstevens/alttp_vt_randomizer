...
return [
	...
	'cards' => [
		...
		'randomize' => [
			...
			'content' => [
				'Head on over to <a href="/randomizer" target="_blank" rel="noopener noreferrer">' . __('navigation.randomizer') . '</a> and provide your ROM. The next screen will show a variety of game options. For your first few runs, we recommend changing “' . __('randomizer.difficulty') . '” to “' . __('randomizer.easy') . '” and leaving the rest of the settings as is. Then click “' . __('randomizer.generate') . '” and you’ll be given a newly minted randomized game!',
		...
		'emulator' => [
			...
			'content' => [
				...
				'While you can play using only your keyboard, a controller makes for a better experience. While most USB controllers will work, we recommend an <a href="https://www.amazon.com/dp/B002B9XB0E" target="_blank" rel="noopener noreferrer">iBuffalo Classic USB Gamepad</a> or an <a href="https://www.amazon.com/dp/B00Y0LUQFE" target="_blank" rel="noopener noreferrer">8Bitdo SFC30 Wireless Bluetooth Controller</a>.',
